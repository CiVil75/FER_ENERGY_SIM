...
LANG_DICT = {
    "ITA": {
        ...
        "c1_title": "##### 🏛️ Configurazione 1: Standard BESS (Casa)",
        ...
        "final_x": "Mese dell'Anno", "final_l1": "Fabbisogno Utenza Lordo", "final_l2": "Autoconsumo con BESS Standard", "final_l3": "Autoconsumo Integrato V2H",
    ...
    "ENG": {
        ...
        "c1_title": "##### 🏛️ Configuration 1: Standard BESS (Home)",
        ...
        "final_x": "Month of the Year", "final_l1": "Gross Load", "final_l2": "Self-Consumption with Standard BESS", "final_l3": "V2H Integrated Self-Consumption",
...
if st.button(T["run_btn"], type="primary", use_container_width=True):
    ...
    for season_name, section_title in zip(seasons_list, titles_list):
        ...
        with col_chart1:
            ...
            # Linee distinte e carichi impilati visivamente
            ax_f1.plot(range(24), s_data["load_base_heat"], label=T["legend_base_heat"], color="#475569", lw=1.1, linestyle="-")
    ...
    ax12.bar([x for x in x_idx], monthly_autoconsumo_s1, width=0.22, label=T["final_l2"], color='#EA580C', alpha=0.8)

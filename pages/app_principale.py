...
if st.session_state.sim_data is not None:
    ...
    for tab_obj, season_name in season_mapping:
        ...
        with tab_obj:
            ...
            with c_fabb1:
                ...
                ax_meteo.plot(h_range, temp_s, label="Temp. Esterna" if lang=="ITA" else "Ext. Temp", color="#EA580C", lw=1.6, linestyle=":")
    ...
    with c_an_f1:
        ...
        ax_ann_temp.plot(t_range, sim["temp"][s_idx:e_idx], color="#EA580C", lw=1, linestyle=":", label="Temp. Esterna" if lang=="ITA" else "Ext. Temp")
